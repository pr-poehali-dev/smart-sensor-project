...
const steps = [
  {
    number: "01",
    title: "Напиши мне в Telegram",
    description: "Выбери одно из 3 направлений и напиши мне в Telegram — я выдам твою персональную реферальную ссылку.",
  ...
  {
    number: "02",
    title: "Делись ссылкой и приводи людей",
    description: "Распространяй ссылку среди друзей, в соцсетях, чатах. Каждый, кто оформит карту, выйдет курьером или закажет инфографику — твой лид.",
  ...
  },
  {
    ...
    description: "Деньги приходят на карту: за карты — 10–20 дней, за курьеров Яндекс.Еды — 5–10 дней, за инфографику — быстрее всего.",
