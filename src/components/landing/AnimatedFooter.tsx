    ...
    <footer id="contact" className="relative bg-black border-t border-gray-800/50">
      ...
      <div className="relative z-10 border-b border-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            <h3 className="text-3xl sm:text-4xl font-bold text-white mb-4">Новые способы заработка — каждую неделю</h3>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Подпишись и получай свежие идеи для заработка, реальные кейсы и проверенные стратегии дохода.
            </p>
          </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          ...
          >
            ...
            <p className="text-gray-400 text-lg leading-relaxed max-w-md mx-auto lg:mx-0">
              Самый полный каталог способов заработка в интернете и офлайн. Реальные пути к финансовой свободе без воды и мифов.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center sm:text-left">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h4 className="text-lg font-semibold text-white mb-6">Способы заработка</h4>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-gray-400 justify-center sm:justify-start">
                  ...
                  <span>info@mirзаработка.ru</span>
                </div>
                <div className="flex items-center space-x-3 text-gray-400 justify-center sm:justify-start">
                  <Phone className="h-5 w-5 text-blue-500" />
                  <span>Telegram: @mirзаработка</span>
                </div>
                <div className="flex items-center space-x-3 text-gray-400 justify-center sm:justify-start">
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 text-center sm:text-left">
            <p className="text-gray-500 text-sm">
              {new Date().getFullYear()} МирЗаработка. Все права защищены.
            </p>
